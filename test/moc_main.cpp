...
#ifdef QT_MOC_HAS_STRINGDATA
struct qt_meta_stringdata_CLASSTest2ENDCLASS_t {};
static constexpr auto qt_meta_stringdata_CLASSTest2ENDCLASS = QtMocHelpers::stringData(
    "Test2"
);
#else  // !QT_MOC_HAS_STRING_DATA
struct qt_meta_stringdata_CLASSTest2ENDCLASS_t {
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSTest2ENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSTest2ENDCLASS_t qt_meta_stringdata_CLASSTest2ENDCLASS = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_CLASSTest2ENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Test2::staticMetaObject = { {
    QMetaObject::SuperData::link<Test::staticMetaObject>(),
    qt_meta_stringdata_CLASSTest2ENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSTest2ENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSTest2ENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_CLASSTest2ENDCLASS.stringdata0))
        return static_cast<void*>(this);
